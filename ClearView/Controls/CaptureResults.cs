...
namespace EPIC.Controls
{
	...
	public class CaptureResults : IDisposable
	{
		...
		public CaptureResults(List<Tuple<long, Bitmap, ImageEntity>> images, int closestIndex, CaptureEntity capture)
		{
			this._images = images;
		...
		public List<Tuple<long, Bitmap, ImageEntity>> Tuples
		{
			get
			{
				return this._images;
		...
		public CaptureEntity Capture
		{
			get
			{
				Tuple<long, Bitmap, ImageEntity> tuple = this._images.FirstOrDefault<Tuple<long, Bitmap, ImageEntity>>();
				if (tuple == null)
				{
					throw new NotSupportedException();
				}
				ImageCaptureEntity capture = tuple.Item3.Capture;
				CaptureEntity result;
				if (capture == null)
				{
					result = null;
				}
		...
		public void Dispose()
		{
			...
			foreach (Tuple<long, Bitmap, ImageEntity> tuple in this._images)
			{
				tuple.Item2.Dispose();
			}
		}
		...
		public Tuple<long, Bitmap, ImageEntity> this[Bitmap image]
		{
			get
			{
				return this._images.FirstOrDefault((Tuple<long, Bitmap, ImageEntity> x) => x.Item2.Equals(image));
			}
		}

		// Token: 0x1700003B RID: 59
		public Tuple<long, Bitmap, ImageEntity> this[long image]
		{
			get
			{
				return this._images.FirstOrDefault((Tuple<long, Bitmap, ImageEntity> x) => x.Item1.Equals(image));
			}
		}

		// Token: 0x1700003C RID: 60
		public Tuple<long, Bitmap, ImageEntity> this[int image]
		{
			get
			{
		...
		public Tuple<long, Bitmap, ImageEntity> this[ImageEntity image]
		{
			get
			{
				return this._images.FirstOrDefault((Tuple<long, Bitmap, ImageEntity> x) => x.Item3.Equals(image));
			}
		}

		// Token: 0x0400007E RID: 126
		private readonly List<Tuple<long, Bitmap, ImageEntity>> _images;

		// Token: 0x0400007F RID: 127
		private readonly int _closest;

		// Token: 0x04000080 RID: 128
		private readonly CaptureEntity _capture;
